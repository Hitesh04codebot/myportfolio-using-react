  ...
  return (
    <div className="w-vw bg-black flex flex-row max-md:flex-col gap-10 items-center p-10 mt-2 h-auto max-md:p-3 max-md:gap-3">
      ...
      >
        ...
        <button
          type="submit"
          className="flex items-center gap-2 px-5 py-2 bg-linear-to-r from-purple-500 via-indigo-500 to-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 hover:shadow-lg transition duration-300"
        >
          Submit
        </button>
      </motion.form>
