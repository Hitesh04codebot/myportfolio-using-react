...
function Home() {
  return (
    <div
      className="flex flex-row max-sm:flex-col justify-center items-center cursor-pointer "
      id="home"
    >
      ...
      <div className="w-1/2  h-125 bg-black flex justify-center items-center montserrat-font max-sm:h-auto max-sm:w-full max-sm:p-4 max-lg:flex-col max-lg:justify-center max-lg:items-center">
        <div className="w-auto h-auto ">
          ...
          <motion.p
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="text-2xl text-center font-bold text-white max-sm:text-2xl  drop-shadow-[0_0_2px_white]"
          >
          ...
          <motion.p
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="text-6xl text-center font-extrabold text-white max-sm:text-4xl  drop-shadow-[0_0_2px_white] max-md:text-3xl"
          >
